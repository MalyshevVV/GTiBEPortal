...
var update = add("1b5217e0", content, false, {});
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-4ae020d8","hasScoped":false,"optionsId":"0","buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/layouts/default.vue
var render = function() {
  var _vm = this
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("q-list-header", [_vm._v("Разделы портала")]),
              _vm._v(" "),
              _c(
                "q-item",
                [
                  _c("router-link", { attrs: { to: "/case" } }, [
                    _vm._v("Кейсы")
                  ])
                ],
                1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4ae020d8", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4ae020d8", Component.options)
  } else {
    hotAPI.reload("data-v-4ae020d8", Component.options)
  }
...
//# sourceMappingURL=5.9167e21d0e0add207f06.js.map